...
import {clearNotifications, ignoreNotificationAsync, markAsReadAsync} from "@/redux/notifications/NotificationSlice";
...
const DashMenu = () => {
    ...
    return (
        <nav
            className="fixed top-0 left-0 right-0 z-50 glass dark:glass-dark border-b border-gray-200/50 dark:border-gray-700/50">
            <div className="max-w- mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    {/* Logo */}
                    <div className="flex-shrink-0 flex items-center">
                        {companyName ? (
                            <img src={companyName} alt="Company Logo" className="h-6 w-auto"/>
                        ) : (
                  ...
                  MosTech
                        ...
                        <div className="flex space-x-6">
                            {menuData?.map((menuItem) => (
                                <MenuItem
                                    ...
                                    activeMenuPath={activeMenuPath}
                                    setActiveMenuPath={setActiveMenuPath}
                                    onMenuOpen={() => setActiveDropdown(null)}
                                />
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="dropdown-container relative">
                            ...
                            {activeDropdown === 'profile' && (
                                <div
                                    className="absolute right-0 mt-2 w-72 glass bg-white dark:glass-dark rounded-xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                                    <div className="p-4">
                                        <div className="flex items-center space-x-3 mb-4">
                                            <div
                                                className="h-12 w-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center">
                                        ...
                                        <div className="space-y-2">
                                            <div
                                                className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-gray-50/50 dark:bg-gray-800/50">
                                                <Building2 className="h-4 w-4 text-gray-500"/>
                                                <span
                                                    className="text-sm text-gray-600 dark:text-gray-300">ID: {userId}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    {notifications.filter((n) => !n.read).length}
                            ...
                            {activeDropdown === 'notifications' && (
                                <div
                                    className="absolute right-0 mt-2 w-96 glass bg-white dark:glass-dark rounded-xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                                    <div className="p-4">
                                                ...
                                                {notifications.map((notification) => (
                                                    <div key={notification.id} className="flex items-start space-x-4">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            <button
                                                                onClick={() => dispatch(markAsReadAsync(notification.id))}
                                                                className="p-1 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                                                            >
                                                                <Check className="h-4 w-4 text-green-500"/>
                                                            </button>
                                                            <button
                                                                onClick={() => dispatch(ignoreNotificationAsync(notification.id))}
                                                                className="p-1 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                                                            >
                        ...
                        <div className="dropdown-container relative">
                            ...
                            {activeDropdown === 'settings' && (
                                <div
                                    className="absolute right-0 mt-2 w-56 glass bg-white dark:glass-dark rounded-xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg overflow-hidden">
                                    <div className="p-2">
                                        <button
