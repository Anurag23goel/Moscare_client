...
const CellMListingDataTable = ({getRowClassName, rows, rowSelected, handleCellClick, props}) => {
        ...
        <div>
            <Box sx={{height: "100vh", minHeight: '400px', width: "100%", maxHeight: "500px"}}>
                <DataGrid
                    ...
                    onCellClick={(row) => handleCellClick(row.row)}
...
export default CellMListingDataTable;
