...
export const fetchExpensesData = async () => {
    try {
        const data = await fetchData("/api/getExpenses", window.location.href);
...
const updateExpenses = ({expensesData, setExpensesData, setShowForm}) => {
  ...
  Delete: "",
    ...
    useEffect(() => {
        ...
        fetchUserRoles('m_expenses', "Maintainence_Expense_Category", setDisableSection);
    }, []);
    ...
    const handleSave = async () => {
        ...
        Delete: selectedRowData.Delete ? "Y" : "N",
            ...
            setExpensesData(await fetchExpensesData());
        } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 pt-24 sm:px-6 lg:px-8 py-8">
            ...
            <div
                ...
                <CustomAgGridDataTable2
                    ...
                    title="Expense"
                    subtitle="Manage all Expense. Click on Edit to update their Expense."
                    primaryButton={{
                        label: "Add Expense",
                ...
                <EditModal
                    ...
                    onSave={handleSave}
                    modalTitle="Edit Expense Details"
                    fields={modalFields}
