...
const UpdateRoster = ({setRosterData, rosterData, setShowForm}) => {
  ...
  Delete: "",
    ...
    useEffect(() => {
        ...
        fetchUserRoles('m_roster_ctg', "Maintainence_Roster_Category", setDisableSection);
    }, []);
    ...
    const handleSave = async () => {
      ...
      const data = await putData(
          "/api/updateRosterCategory",
          selectedRowData,
          window.location.href
      );
            console.log("Save clicked:", data);
            addValidationMessage("Roster Updated Successfully", "success");
            setRosterData(await fetchRosterData());

        } catch (error) {
            console.error("Error fetching area data:", error);
            addValidationMessage("Error updating Roster data:", "error");
        }
        setShowModal(false);
    ...
    const modalFields = [
        {id: "Code", label: "Category Code", type: "text"},
        ...
        <div className="max-w-7xl mx-auto px-4 pt-24 sm:px-6 lg:px-8 py-8">
            ...
            <div
                ...
                <CustomAgGridDataTable2
                    ...
                    primaryButton={{
                        label: "Add Roster Category",
                        icon: <PlusCircle className="h-4 w-4"/>,
                        onClick: () => setShowForm(true),
                        // disabled: disableSection,
                    }}

                    rows={rosterData.data}
                ...
                <EditModal
                    ...
                    onSave={handleSave}
                    modalTitle="Edit Roster Details"
                    fields={modalFields}
