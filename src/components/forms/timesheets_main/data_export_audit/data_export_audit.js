...
export default function DataExportAudit() {
    ...
    const getData = async () => {
        ...
        const sortedDates = dates.sort((a, b) => compareDesc(parseISO(a), parseISO(b)));

        const todayDate = sortedDates.find((date) => isToday(parseISO(date))) || sortedDates[0];
        ...
        <div className="">
                ...
                <div
                    ...
                    <CustomAgGridDataTable
                        ...
                        columns={columns?.filter(
                            (col) =>
                                !["Maker User", "Maker Date", "Update User", "Update Time"].includes(
                                    col.headerName
                                )
                        )}
            ...
            {showModal && selectedRowData && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div
                        className="relative w-full max-w-3xl mx-4 glass dark:glass-dark rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl">
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p className="text-sm font-medium">{selectedRowData.RequestID}</p>
                                        </div>
                                        <div>
                                            <label className="text-xs text-gray-500">Export Type</label>
                                            <p className="text-sm font-medium">{selectedRowData.TypeOfExport}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-medium">{selectedRowData.UserExported}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <pre
                                        className="text-sm bg-gray-50/50 dark:bg-gray-800/50 rounded-lg p-4 overflow-x-auto">
                    {JSON.stringify(JSON.parse(selectedRowData.Request || "{}"), null, 2)}
                  </pre>
                                </div>
                                ...
                                <div
                                    ...
                                    <pre
                                        className="text-sm bg-gray-50/50 dark:bg-gray-800/50 rounded-lg p-4 overflow-x-auto">
                    {JSON.stringify(JSON.parse(selectedRowData.Response || "{}"), null, 2)}
                  </pre>
                                </div>
                            </div>
                        </div>
